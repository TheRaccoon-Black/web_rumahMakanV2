...
<form action="loginck.php" method="post">
  ...
  <table border="0" align="center" cellpadding="5" cellspacing="7">
	        ...
	        <tr align="right">	
		     <td> <img src="Login.png" style="width: 30%"> <br>
		      <a href="registrasi.php"> Pengguna Baru?</a></td>
		 </tr>
		<tr>
 ...
 <td> <input type="Password" name="pass" placeholder="Enter Your Password" style="padding: 10px; width: 150%"> <br>   </td>
		...
		<tr>	    
 <td align="right"> <input type="submit" name="" value="Login Sekrang" style="color: red; background-color: lightgreen; font-size: 1.5em; font-family: times new roman;"> </td> 
</tr>
